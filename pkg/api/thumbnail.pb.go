...
type ThumbnailRequest struct {
	...
	VideoUrl      string                 `protobuf:"bytes,1,opt,name=video_url,json=videoUrl,proto3" json:"video_url,omitempty"` // URL видеоролика
...
type ThumbnailResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ImageData     []byte                 `protobuf:"bytes,1,opt,name=image_data,json=imageData,proto3" json:"image_data,omitempty"`       // Данные изображения миниатюры
	VideoUrl      string                 `protobuf:"bytes,2,opt,name=video_url,json=videoUrl,proto3" json:"video_url,omitempty"`          // URL видеоролика
	CacheStatus   string                 `protobuf:"bytes,3,opt,name=cache_status,json=cacheStatus,proto3" json:"cache_status,omitempty"` // Статус кэширования миниатюры
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ThumbnailResponse) GetCacheStatus() string {
	if x != nil {
...
var file_thumbnail_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x2f, 0x0a, 0x10, 0x54, 0x68, 0x75, 0x6d, 0x62, 0x6e,
	...
	0x69, 0x64, 0x65, 0x6f, 0x55, 0x72, 0x6c, 0x22, 0x72, 0x0a, 0x11, 0x54, 0x68, 0x75, 0x6d, 0x62,
	...
	,
...
var file_thumbnail_proto_depIdxs = []int32{
	0, // 0: api.ThumbnailService.DownloadThumbnail:input_type -> api.ThumbnailRequest
	1, // 1: api.ThumbnailService.DownloadThumbnail:output_type -> api.ThumbnailResponse
